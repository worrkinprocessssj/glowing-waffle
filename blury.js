// blury IS A PRIVATE METHOD BASED ON TLS BYPASS BUT BETTER
// SANTA HAVE CF BYPASS AND CAPTCHA BYPASS (also bypass a lot of common protections)
// THIS METHOD IS USING HTTP PROXIES IN IP:PORT FORMAT
// THIS METHOD IS MADE BY BLURYFXCE
 ...
 (async () => {
  ...
  // Your code that uses gradient-string
})();
 ...
 Usage: node blury.js target time rqs threads proxyfile
 Example: node blury.js https://youaregay.com 60 10 10 proxy.txt`);; process.exit();}
 const headers = {};
...
console.log(`blury PRIVATE METHOD`)
